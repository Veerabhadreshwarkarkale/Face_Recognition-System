...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Developer",font=("veera",20,"bold"),bg="navyblue",fg="white")
        ...
        #label Name
        name_label=Label(right_frame,text="Name:",font=("veera",12),bg="white")
        name_label.grid(row=0,column=0,padx=5,pady=12)
        #Name
        name=Label(right_frame,text="VEERABHADRESHWAR",font=("veera",12,"bold"),bg="white", fg="navyblue",)
        name.grid(row=0,column=1,padx=5,pady=12,sticky=W)
        
        #label ID
        idstd_label=Label(right_frame,text="Course:",font=("veera",12),bg="white")
        idstd_label.grid(row=1,column=0,padx=5,pady=12)
        #ID
        idstd=Label(right_frame,text="BE(ECE)",font=("veera",12,"bold"),bg="white", fg="navyblue",)
        idstd.grid(row=1,column=1,padx=5,pady=12,sticky=W)

        #label class
        classStd_label=Label(right_frame,text="Roll No:",font=("veera",12),bg="white")
        classStd_label.grid(row=2,column=0,padx=5,pady=12)
        #class
        classStd=Label(right_frame,text="20SECE1010767",font=("verdana",12,"bold"),bg="white",fg="navyblue",)
